...
function Badge(_ref) {
  ...
  return /*#__PURE__*/React__default['default'].createElement("a", _extends({
    ...
    title: name,
    className: className
  }, rest), /*#__PURE__*/React__default['default'].createElement("img", {
    src: svg,
    alt: alt
  }));
}
...
function Widget(_ref2) {
  ...
  var appStore = appStoreUrl && /*#__PURE__*/React__default['default'].createElement(Badge, _extends({
    key: "appstore",
    name: name,
    url: appStoreUrl,
    svg: img$1,
  ...
  var googlePlay = googlePlayUrl && /*#__PURE__*/React__default['default'].createElement(Badge, _extends({
    key: "googleplay",
    name: name,
    url: googlePlayUrl,
    svg: img,
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", null, badges);
}
